...
export default function BarcodeScannerIndex({
    search,
    stockUnit,
    notFound,
}: Props) {
            ...
            <div className="container mx-auto space-y-6 px-6 py-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Scan barcode/IMEI menggunakan scanner USB atau input
                            manual.
                        </p>
                    </div>
                </div>
                ...
                {stockUnit && (
                    <div className="rounded-xl border bg-card p-6 shadow-sm">
                        ...
                        <div className="mt-5">
                            <Link
                                href={`/my-admin/dashboard/ecommerce/product-stock-units/${stockUnit.id}`}
                            >
                                <Button variant="outline">
                                    View Detail Stock Unit
                                </Button>
                            </Link>
                        </div>
                    </div>
