            ...
            <div className="container mx-auto max-w-5xl space-y-8 px-6 py-8">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">
                        Cara Penggunaan Site Contents
                    </h1>
                    <p className="mt-1 text-sm text-muted-foreground">
                        Panduan integrasi content key-value multi-language untuk
                        frontend Inertia dan Next.js.
                    </p>
                </div>

                <section className="space-y-3 rounded-xl border border-border bg-card p-6">
                    <h2 className="text-lg font-semibold">
                        1. Ambil Content Berdasarkan Group
                    </h2>
                    <p className="text-sm text-muted-foreground">
                        Gunakan service <code>SiteContentService</code> di
                        controller Laravel:
                    </p>
...
<p>{contents['homepage.hero.subtitle'] ?? 'Fallback Subtitle'}</p>`}
                    ...
                    <p className="text-sm text-muted-foreground">
                        Selalu pakai fallback supaya tampilan tidak kosong jika
                        translation belum diisi.
                    </p>
                </section>
            </div>
        </>
