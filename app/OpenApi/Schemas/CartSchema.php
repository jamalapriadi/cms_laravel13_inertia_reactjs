...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'thumbnail', type: 'string', nullable: true, example: 'https://gitatrading-store.com/storage/products/iphone-15-pro.jpg'),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'image', type: 'string', nullable: true, example: 'https://gitatrading-store.com/storage/products/iphone-15-pro-black.jpg'),
