...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'image', type: 'string', nullable: true, example: 'media/2026/06/hero.webp'),
        new OA\Property(property: 'image_url', type: 'string', nullable: true, example: 'https://img.gitatrading-store.com/media/2026/06/hero.webp'),
        new OA\Property(property: 'mobile_image', type: 'string', nullable: true, example: 'media/2026/06/hero-mobile.webp'),
        new OA\Property(property: 'mobile_image_url', type: 'string', nullable: true, example: 'https://img.gitatrading-store.com/media/2026/06/hero-mobile.webp'),
